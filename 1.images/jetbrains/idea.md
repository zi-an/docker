# 软件安装+环境变量
```
wget https://zian.netlify.app/debian/jetbra.tgz
mkdir /jetbrains/idea -p
wget https://download.jetbrains.com/idea/ideaIU-2024.2.6.tar.gz
tar -zxvf ideaIU-2024.2.6.tar.gz -C /jetbrains/idea --strip-components=1

alias loadidea="cp /jetbrains/idea /tmp/ -r"
alias idea="nohup /jetbrains/idea/bin/idea &"
export PATH=$PATH:/tmp/idea/jbr/bin/:/jetbrains/idea/jbr/bin/
export IDEA_VM_OPTIONS="/jetbrains/jetbra/vmoptions/idea.vmoptions"
export GOLAND_VM_OPTIONS="/jetbrains/jetbra/vmoptions/goland.vmoptions"
```
